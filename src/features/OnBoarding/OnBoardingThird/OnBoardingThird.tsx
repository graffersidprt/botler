...
import StatementAnalysisImage from "../../../assets/images/statement-analysis-img-3.svg";
    ...
    <Box sx={{ display: { sm: "block", md: "none", lg: "none", xl: "none" } }}>
      <div className={classes.mainContainer}>
        ...
        <div className={classes.contentContainer}>
          ...
          >
            Botler backs you in enforcing your rights, guides you through the correct avenues and stands with you throughout the process of reaching a resolution.
          </Typography>
